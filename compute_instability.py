...
import random
import numpy as np
from tools.comput_metric import compute_metric
import torch
...
parser.add_argument('--net_path',type=str,default='/data/LZL/ICNN/task/classification/vgg_vd_16/vocpart/cat/1/net-50.pkl',
